...
loadIngredients();
loadLabels();
Promise.all([loadLabels(), loadIngredients()]).then(() => {
  ...
  */
  ...
  labelsObjects.forEach((e) => {
    ...
    printButton.innerHTML =
      "<i class='bi-printer align-self-center h-100 w-100'></i>";
    ...
    editButton.innerHTML =
      "<i class='bi-pencil align-self-center h-100 w-100'></i>";
    ...
    deleteButton.innerHTML =
      "<i class='bi-trash-fill align-self-center h-100 w-100'></i>";
    ...
    printModalDialogue.className =
      "modal-dialog modal-xl modal-dialog-centered modalHeight";
    ...
    myIDs.forEach((z) => {
      ...
      for (let b = 0; b < ingredientsObjects.length - 1; b++) {
        ...
        if (z == ingredientsObjects[b].ingredient_id) {
          ...
          if (
            ingredientsObjects[b].ingredient_name.toLowerCase().includes("base")
          ) {
            myDescription =
              ingredientsObjects[b].ingredient_name + ", " + myDescription;
            myIngredients =
              ingredientsObjects[b].ingredient_name +
              "(" +
              ingredientsObjects[b].ingredient_contents +
              ")," +
              myIngredients;
          } else {
    ...
    descriptionBox.setAttribute(
      "style",
      "text-align:center; font-family:Wire One,Hepta Slab,serif,sans-serif; font-size: 10pt"
    );
    ...
    ingredientsDiv.setAttribute(
      "style",
      "font-family:Wire One,Hepta Slab,serif,sans-serif;"
    );
    ingredientsDiv.innerHTML = myIngredients;
    let allergensDiv = document.createElement("div");
    allergensDiv.setAttribute(
      "style",
      "font-family:Wire One,Hepta Slab,serif,sans-serif;"
    );
    ...
    printBox.innerHTML += "<br>";
    printBox.innerHTML +=
      "<div class='d-flex justify-content-center' style='text-align:center; font-family:Wire One,Hepta Slab,serif,sans-serif; margin-bottom: 15pt;'><b class='text-center'>PDX Cookie Co - 7919 SE Stark St Portland OR 97215</b></div>";
    printBox.innerHTML +=
      "<div class='d-flex justify-content-center' style='text-align:center; font-family:Wire One,Hepta Slab,serif,sans-serif; font-size: 15pt;'><b class='text-center'>Net Wt 5.0 Oz (142g)</b></div><br>";
    ...
    saveBtn.addEventListener("click", (j) => {
      ...
      myWindow.document.write(
        '<link href="https://fonts.googleapis.com/css2?family=Hepta+Slab&family=Wire+One&display=swap" rel="stylesheet">'
      );
      myWindow.document.write("<body>");
      myWindow.document.write(
        '<div style="height:525px; font-weight:bold; width:350px; font-size:' +
          fontString +
          '">'
      );
      ...
      myWindow.document.write(
        '<p style="font-family:Wire One,sans-serif; font-weight:bold; letter-spacing:1px">'
      );
    ...
    editModalSearch.className =
      "form-control mt-1 mb-4 mx-auto border border-dark modalSearch";
    ...
    editModalScroll.className =
      "modalScroll border border-secondary border-rounded mx-auto mt-3 mb-3";
    let editModalScrollAll = document.createElement("div");
    editModalScrollAll.className =
      "modalScrollAll border border-secondary mx-auto mt-3 mb-3";
    let tableTitleBox = document.createElement("div");
    tableTitleBox.className =
      "d-flex justify-content-center mx-auto titlesBoxWidth";
    ...
    myIDs.forEach((z) => {
      ...
      for (let b = 0; b < ingredientsObjects.length - 1; b++) {
        ...
        if (z == ingredientsObjects[b].ingredient_id) {
          ...
          editModalPrimaryColumn.innerHTML =
            ingredientsObjects[b].ingredient_name;
          ...
          editModalRemoveButton.innerHTML =
            "<i class='bi-dash-square align-self-center h-100 w-100 editModalRemoveButton minusIcon'></i>";
          ...
          editModalRemoveButton.addEventListener("click", (s) => {
            ...
            let targetIngredientId =
              s.target.parentNode.parentNode.previousSibling.firstChild.value;
  ...
  labelsObjects.forEach((u) => {
    ...
    hiddenIdAll.setAttribute(
      "value",
      ingredientsObjects[ingredientsIndex].ingredient_id
    );
    ...
    for (let w = 0; w < ingredientsObjects.length; w++) {
      ...
      editModalPrimaryColumnAll.innerHTML =
        ingredientsObjects[w].ingredient_name;
      ...
      editModalRemoveButtonAll.innerHTML =
        "<i class='bi-plus-square align-self-center h-100 w-100 editModalAddButton addIcon'></i>";
      ...
      editModalRemoveButtonAll.addEventListener("click", (m) => {
        ...
        // find target's ingredient id
        let targetIngredientIdAll =
          m.target.parentNode.parentNode.previousSibling.firstChild.value;
        ...
        let newListenerTarget = document.querySelectorAll(
          ".editModalResults > tr > td > button"
        );
        ...
        let entriesAll = document.querySelectorAll(
          ".editModalResults > tr > td > button"
        );
        entriesAll.forEach((h) => {
          if (h.className.includes("editModalAddButton")) {
            let newClass4 = h.className.replace(
              "editModalAddButton",
        ...
        let buttonAll = document.querySelectorAll(
          ".editModalResults > tr > td > button > i"
        );
        buttonAll.forEach((v) => {
          if (v.className.includes("editModalAddButton")) {
            let newClass5 = v.className.replace(
              "editModalAddButton",
              "editModalRemoveButton"
            );
