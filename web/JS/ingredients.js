...
Promise.all([loadLabels(), loadIngredients()]).then(() => {
  ...
  ingredientsObjects.forEach((e, realIndex) => {
    ...
    editButton.innerHTML =
      "<i class='bi-pencil align-self-center h-100 w-100 editButton'></i>";
    ...
    deleteButton.innerHTML =
      "<i class='bi-trash-fill align-self-center h-100 w-100 deleteButton'></i>";
    deleteButton.type = "button";
    deleteButton.setAttribute("data-bs-toggle", "modal");
    let deleteModalNameCopy = "#" + deleteModalName;
    deleteButton.setAttribute("data-bs-target", deleteModalNameCopy);
    deleteButton.className =
      "btn btn-dark ms-2 me-2 mainTableButton deleteButton";
    ...
    tree_nutsInput.addEventListener("change", (a) => {
      let treeNutBox =
        a.target.parentNode.nextSibling.nextSibling.nextSibling.nextSibling
          .childNodes[1];
